...
public class GuildFeedFragment extends Fragment {
	View rootView;
	LinearLayout layout;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.fragment_guild_feed, container,
				false);
		layout = (LinearLayout) rootView.findViewById(R.id.guildFeedContainer);
		getDataFromServer();
		return rootView;
	}
